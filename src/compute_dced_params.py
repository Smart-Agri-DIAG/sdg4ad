...
def get_edge_percentages(img_paths, kernel_size, lower_th_wide, upper_th_wide, lower_th_narrow, upper_th_narrow):
...
def get_best_threshold(good_img_paths, bad_img_paths, kernel_size, lower_th_wide, upper_th_wide, lower_th_narrow, upper_th_narrow):
    good_edge_percentages = get_edge_percentages(good_img_paths, kernel_size, lower_th_wide, upper_th_wide,
                                                 lower_th_narrow, upper_th_narrow)
